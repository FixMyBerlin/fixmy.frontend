...
const TrafficOrder = ({ application }: Props) => {
    ...
    <Container>
      ...
      <TwoUp>
        <span>
          ...
          <p>Veranstaltung mit dem Titel &ldquo;{application.title}&rdquo;</p>
        </span>
      ...
      <TwoUp>
        <span>
          ...
          <br />
          Am {eventDate(application)} um {application.setup_start.slice(0, -3)}{' '}
          Uhr
        </span>
        <span>
          <strong>Aufhebung der Arbeitsstelle</strong>
          <br />
          Am {eventDate(application)} um {application.teardown_end.slice(0, -3)}{' '}
          Uhr
        </span>
      </TwoUp>
      <p>
