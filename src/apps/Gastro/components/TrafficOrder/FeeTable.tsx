        ...
        <table cellSpacing="0" cellPadding="0">
          ...
          <tr>
            <td colSpan={11} style={{ textAlign: 'left' }}>
              ...
              meiner Dienststelle gespeichert. Die Datei wurde gemäß §§ 19 und
              19 a Abs. 1 Berliner Datenschutzgesetz (BlnDSG) mit der
              Dateibeschreibung dem behördlichen Datenschutzbeauftragten
              gemeldet. Die Dateibeschreibungen und Verzeichnisse können von
              jeder Person beim behördlichen Datenschutzbeauftragten eingesehen
              werden.
            </td>
          </tr>
        </table>
