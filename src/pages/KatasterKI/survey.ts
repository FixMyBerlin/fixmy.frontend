...
const scenesConfig = (
  ...
  const feedbackScreen = {
    type: 'feedback',
    title:
      'Tragen Sie hier Ihre Email-Adresse ein, wenn Sie möchten, dass der Tagesspiegel und FixMyBerlin Sie über die Ergebnisse der Umfrage informieren.',
    name: 'feedback'
  };
  ...
  const emailScreen = {
    ...
    thankyou:
      'Danke, wir haben Ihnen eine Email geschickt. Klicken Sie dort auf den Link zur Bestätigung.',
    name: 'email'
  };
