typescript-json-schema src/pages/KatasterKI/types.ts ProfileRequest --ignoreErrors -o src/pages/KatasterKI/scheme/profile-request.schema.json
typescript-json-schema src/pages/KatasterKI/types.ts ProfileResponse --ignoreErrors -o src/pages/KatasterKI/scheme/profile-response.schema.json
