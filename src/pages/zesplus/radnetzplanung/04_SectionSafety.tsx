...
export const SectionSafety = (props: SectionProps) => (
  <>
    ...
    <Paragraph>
      ...
      der objektiven wie auch der subjektiven Sicherheit im Radverkehr zusammen.
      In der interaktiven Karte sind tatsächliche Unfälle verortet sowie
    ...
    <Paragraph>
      ...
      ein hoher Handlungsdruck. Aber auch Strecken ohne Unfallaufkommen können
      als unsicher wahrgenommen werden und ungeübte Radfahrende von der
